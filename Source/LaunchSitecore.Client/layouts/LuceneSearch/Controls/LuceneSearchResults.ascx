<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LuceneSearchResults.ascx.cs"
 Inherits="LaunchSitecore.layouts.LuceneSearch.Controls.LuceneSearchResults" %>
...
<div id="contentblock">
 ...
 <asp:Repeater id="SearchResults" runat="server" OnItemDataBound="rptSearchResults_ItemDataBound">
  <ItemTemplate>
