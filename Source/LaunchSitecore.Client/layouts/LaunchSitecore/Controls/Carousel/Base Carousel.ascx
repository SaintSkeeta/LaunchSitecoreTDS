<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Base Carousel.ascx.cs" Inherits="LaunchSitecore.layouts.LaunchSitecore.Controls.Carousel.Base_Carousel" %>
 ...
 <div class="carousel-inner">
  <asp:Repeater ID="rptItems" runat="server" OnItemDataBound="rptItems_ItemDataBound">
   ...
   <ItemTemplate>
     ...
     <div class="carousel-caption carousel-caption-wide">
