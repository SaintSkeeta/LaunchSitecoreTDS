...
{
  public class FieldEditorButtonForPresentationSettings : FieldEditorButton
  {
    public override void Execute(CommandContext context)
    {
      ...
      if (context.Items.Length >= 1)
      {
        ...
        Item pres = db.GetItem(String.Format("{0}/Configuration/Presentation Settings", home.Paths.FullPath), current.Language);    
